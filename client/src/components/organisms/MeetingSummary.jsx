    ...
    try {
      const response = await fetch('https://api.anthropic.com/v1/messages', {
        ...
        body: JSON.stringify({
          ...
          messages: [{
            role: 'user',
            content: `You are a meeting assistant. Analyze this meeting transcript and provide:
...
${transcriptText}`
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50 p-4">
      <div className="bg-gray-900 border border-gray-700 rounded-2xl w-full max-w-2xl max-h-96 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          ...
          {summary && (
            <div className="bg-gray-800 border border-gray-700 rounded-xl p-4 mt-4">
              <h3 className="text-white font-medium mb-3">AI Summary</h3>
